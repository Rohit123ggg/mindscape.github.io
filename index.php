...
else if(isset($_SESSION['email']) && isset($_SESSION['key']) && $_SESSION['key'] == '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39'){
    ...
    <div class="row px-3 mt-4">
      <div class="col-lg-10 col-xl-9 card flex-row mx-auto px-0" >
        ...
        <div class="card-body">
		  ...
		  <form method="post" action="index.php" class="form-box" enctype="multipart/form-data">
            ...
            <div class="text-right">
              <a href="passup.php" class="forget-link">
                Forget Password?
              </a>
            </div>
