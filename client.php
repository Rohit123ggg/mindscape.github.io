<?php
	...
	{	
		...
		$str = "SELECT * FROM fab WHERE user='$user' and pass='$pass'";
    ...
    <div class="row px-3 mt-4">
      <div class="col-lg-10 col-xl-9 card flex-row mx-auto px-0" >
        ...
        <div class="card-body">
		  ...
		  <form method="post" action="client.php" class="form-box" enctype="multipart/form-data">
