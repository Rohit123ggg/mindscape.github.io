...
$ins="insert into fab ( user, pass)
 ...
 if($insertstatus)
 {
     echo "<script>alert('succes');location.href='ahome.php'</script>"; 
 }
 else
 {
  echo "<script>alert('fail');location.href='ahome.php'</script>"; 

  }
echo "<script>location.href='ahome.php'</script>";
...
<form method="post" action="ahome.php" enctype='multipart/form-data'>
    <div class="container">
        <div class="row"> 
        <h3 class=" text-center mt-2" style="color:white;">Client Login Details</h3>
  ...
  <div class="mb-3" style="margin-bottom:20px;color:white">
    <label for="exampleInputPassword1" class="form-label">Password</label>
    <input type="text" class="form-control" id=""name="one" placeholder="Enter Password" required>
  </div>
...
?>
        ...
        <td><a class="btn btn-danger" href="ahome.php?id=<?php echo $row['id']; ?>">Delete</a></td>
...
if (isset($_GET['id'])) {
    ...
    $sql = "DELETE FROM `fab` WHERE `id`='$id'";
